 ...
 * @Last Modified time: 2014-10-26 11:30:57
 */
...
lineHighlight.prototype.getLineUrl = function() {
    ...
    return window.location.protocol + '//' + window.location.host + window.location.pathname + cleanHash + "#I" + this.elementID + "S" + this.element.childNumber + "L" + this.currentIndex;
};
